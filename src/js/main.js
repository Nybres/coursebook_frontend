addEventListener("DOMContentLoaded", event => {
    ...
    btn.addEventListener("click", e => {
      ...
      fetch("/edit-instructor/" + instructorId, {
        ...
        .then(data => {
          ...
          backdropActivate(overlay);
          drawer.classList.add("drawer--active");
          instructorForm.querySelector("[name='first_name']").value =
            data.first_name;
          instructorForm.querySelector("[name='last_name']").value =
            data.last_name;
          instructorForm.querySelector("[name='description']").value =
            data.description;
  ...
  if (instructorForm) {
    instructorForm.addEventListener("submit", e => {
      ...
      const csrfToken = formData.get("csrfmiddlewaretoken");
      fetch(
        isEdit ? "/edit-instructor/" + instructorId : "/account-instructors",
        {
